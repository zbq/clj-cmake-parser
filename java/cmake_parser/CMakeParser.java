...
public class CMakeParser extends Parser {
	...
	public static final int
		...
		Newline=10, Space=11;
	public static final int
		RULE_file = 0, RULE_command_invocation = 1, RULE_single_argument = 2, 
	...
	public static class FileContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CMakeListener ) ((CMakeListener)listener).enterFile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CMakeListener ) ((CMakeListener)listener).exitFile(this);
		}
	}
